<template>
    <div class="container">
      ...
      <div id="mod-0p">
        <h1>
          Privacy Policy for the<br><span class="app-name" style="opacity: 1;">Dropelets</span> App
        </h1>
        <br>
        <p>
          <strong>Last updated:</strong> <span id="mod-0p-date">04/21/2020</span>
          <br>
          <span id="mod-0p-url"></span>
        </p>
        <p>
          We are the developers of <span class="app-name" style="opacity: 1;">Dropelets</span>. This privacy policy describes how we process your personal information and which privacy rights you have when you are using <span class="app-name" style="opacity: 1;">Dropelet</span>. Please contact us at the contact information <a href="#contact_us">below</a> if you have any questions or comments.
        </p>
        <p>
          </p><ol id="links">
    ...
    <p>We do not share any personal information.</p>
      ...
      <div id="sec-title-3P">
        ...
        <div id="mod-3p-content">Neither <span class=" app-name" style="opacity: 1;">Dropelets</span> nor any third party services are using tracking technologies.
  </div>
      </div>
      ...
      <div id="sec-title-4P">
        ...
        <div id="mod-4p-content"><p><span class="app-name" style="opacity: 1;">Dropelets</span> does not use any social login functionality. </p></div>
      </div>
      ...
      <div id="sec-title-5P">
        ...
        <div id="mod-5p-content"><p><span class="app-name" style="opacity: 1;">Dropelets</span> does not process any in-app purchase information.</p></div>
      </div>
      <div id="sec-title-8P">
        <br>
    ...
    Users of <span class="app-name" style="opacity: 1;">Dropelets</span> must be at least 13 years old. We do not knowingly collect personal information from children. If we learn that we have collected personal information from a child, we will take all reasonable steps to delete it as soon as possible. If you become aware that a child has provided personal information to us, please contact us at the contact information <a href="#contact_us">below</a>.
      ...
      <div id="mod-9p-title">
        ...
        <div id="mod-9p-content"><p>We collect no personal information</p></div>
      </div>
      ...
      <div id="sec-title-10P">
        ...
        <div id="mod-10p-content"><p>All the data uploaded to the app is stored offline on the device. Data stored on the app is not accessible by us or any third party. Data is not transmitted online.</p></div>
      </div>
  ...
  <p>When we make material changes to this privacy policy, for example, due to app updates or changes in the law, we will post the updated policy here. The policy will always apply in the version at the time of your use of <span class="app-name" style="opacity: 1;">Dropelet</span> even if you downloaded <span class="app-name" style="opacity: 1;">Dropelet</span> at a time when a previous policy version was applicable.</p>
  </div>
      </div>
  ...
  <p>This website conforms to the <a href="https://www.w3.org/TR/WCAG20/" target="_blank">Web Content Accessibility Guidelines (WCAG) 2.0</a>. However, if you are having difficulties obtaining information from it, please contact us at the contact information <a href="#contact_us">below</a>. We will try to make the information available to you in another format and answer any question that you may have.</p>
      ...
      <div id="sec-title-13P" class="extra-margin-bottom">
        ...
        <div id="mod-13p-name"><p>Kirtan Patel</p></div>
        <div id="mod-13p-email"><p>kirtanpatl@gmail.com</p></div>
      </div>
